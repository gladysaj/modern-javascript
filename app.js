...
// Mouse move (any movement inside the element)
...
//   heading.textContent = `MouseX: ${e.offsetX} and MouseY: ${e.offsetY}`;
...
// Event bubbling, all the classes up will be call
...
// function deleteItem(e){
  ...
  // if(e.target.parentElement.className === 'delete-item secondary-content'){ // .className looks for the entire string 
